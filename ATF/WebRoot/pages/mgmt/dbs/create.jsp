...
<div id="databaseServerCreate" data-vm="dbs.create">
	...
	<atf:form_text text="服务器类型" tip="服务器类型只支持MySql或者SQLServer，请填写:MySql或者SQLServer" bind="value: type, valueUpdate: 'afterkeydown'"></atf:form_text>
	...
	<atf:form_text text="其他信息" tip="支持中文：useUnicode=true&characterEncoding=UTF-8，支持多查询：allowMultiQueries=true" bind="value: more, valueUpdate: 'afterkeydown'"></atf:form_text>
	<!-- /ko -->
	<!-- /ko -->
</div>
<script>
